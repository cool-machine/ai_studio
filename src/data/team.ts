...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'Sarah is a Wharton MBA graduate with over 15 years of experience in technology and venture capital. She founded the Wharton Alumni AI Studio to bridge the gap between AI innovation and industry expertise.',
  ...
  },
  {
    ...
    bio: 'Lisa is a recent Wharton graduate passionate about building communities. She manages our alumni network, WhatsApp groups, and volunteer programs.',
